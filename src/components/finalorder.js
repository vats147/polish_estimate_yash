...
const ManageOrder = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://polish-estimate-backend.vercel.app/getallsizes")
      .then((response) => {
    ...
    axios
      .get("http://polish-estimate-backend.vercel.app/getallgrade")
      .then((response) => {
    ...
    axios
      .get("http://polish-estimate-backend.vercel.app/getallcolor")
      .then((response) => {
    ...
    axios
      .get("http://polish-estimate-backend.vercel.app/getallshape")
      .then((response) => {
...
console.log(`Total CT: ${totalCT}`);
  ...
  const onSubmit = (data) => {
    ...
    axios.post("http://polish-estimate-backend.vercel.app/addorder", submitdata).then((response) => {

  ...
  const ManageSize = ({ onClose, initialValue, mode }) => {
    ...
    const onSubmit = async (data) => {
      try {
        if (mode === "edit") {
          const response = await axios.put('https://polish-estimate-backend.vercel.app/updatesize', { size_id: initialValue.size_id, ...data });
          console.log(response.data);
          toast.success('Size updated successfully!');
        } else {
          const response = await axios.post('https://polish-estimate-backend.vercel.app/addsize', data);
          console.log(response.data);
  ...
  const SizeList = () => {
    ...
    const fetchSizes = async () => {
      try {
        const response = await axios.get("https://polish-estimate-backend.vercel.app/getallsizes");
    ...
    const handleConfirmAction = async () => {
      if (modalType === "delete") {
        try {
          await axios.delete(`https://polish-estimate-backend.vercel.app/deletesize`, {
